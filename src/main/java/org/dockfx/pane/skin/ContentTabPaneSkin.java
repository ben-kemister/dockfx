...
public class ContentTabPaneSkin extends SkinBase<TabPane> {
     ...
     */
    public ContentTabPaneSkin(TabPane control) {
        super(control);
...
//            prefWidth.setValue(tmpPrefWidth);
	...
	/**
	 * This inner class has been modified form the original
	 * {@link javafx.scene.control.skin.TabPaneSkin.TabMenuItem}
	 * 
	 */
    static class TabMenuItem extends RadioMenuItem {
        ...
        public TabMenuItem(final DockNodeTab tab) {
            super(tab.getText(), ContentTabPaneSkin.clone(tab.getGraphic()));
            this.tab = tab;
            setDisable(tab.isDisable());
