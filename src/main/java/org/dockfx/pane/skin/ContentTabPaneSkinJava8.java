 ...
 * different java version, this source might not be working properly. 
 * 
 * The inner class TabMenuItem is modified to handle DockNodeTab title because the tab
 * uses customized graphics
 */
@Deprecated
public class ContentTabPaneSkinJava8 extends SkinBase<TabPane>
{
  ...
  private ObjectProperty<TabAnimation> openTabAnimation =
                                                        new StyleableObjectProperty<TabAnimation>(TabAnimation.GROW)
                                                        {
                                                          ...
                                                          {
                                                            return ContentTabPaneSkinJava8.this;
                                                          }
  ...
  public ContentTabPaneSkinJava8(TabPane tabPane)
  {
...
//  }
  ...
  private static class StyleableProperties
  {
    ...
    private final static CssMetaData<TabPane, TabAnimation> OPEN_TAB_ANIMATION =
                                                                               new CssMetaData<TabPane, ContentTabPaneSkinJava8.TabAnimation>("-fx-open-tab-animation",
                                                                                                                                         ...
                                                                                                                                         TabAnimation.GROW)
                                                                               {
                                                                                 ...
                                                                                 {
                                                                                   ContentTabPaneSkinJava8 skin =
                                                                                                           (ContentTabPaneSkinJava8) node.getSkin();
    ...
    private final static CssMetaData<TabPane, TabAnimation> CLOSE_TAB_ANIMATION =
                                                                                new CssMetaData<TabPane, ContentTabPaneSkinJava8.TabAnimation>("-fx-close-tab-animation",
                                                                                                                                          new EnumConverter<TabAnimation>(TabAnimation.class),
                                                                                                                                          TabAnimation.GROW)
                                                                                {
...
//      listener.dispose();
  ...
  class TabMenuItem extends RadioMenuItem
  {
    ...
    {
      super(tab.getTitle(),
            ContentTabPaneSkinJava8.clone(tab.getGraphic()));
      this.tab = tab;
      setDisable(tab.isDisable());
